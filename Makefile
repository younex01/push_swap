...
BNS_SRC = checker.c checker_utils.c push_swap_utils.c ft_strncmp.c get_next_line.c get_next_line_utils.c push_swap_prep.c ps_operations.c ps_operations_2.c stack_structure.c
OBJS = ${SRC:.c=.o}
BOBJ = ${BNS_SRC:.c=.o}
CC = cc
RM = rm -rf
